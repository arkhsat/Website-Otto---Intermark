        ...
        <tbody>
            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr role="row">
                    ...
                    <td align="right"><?php echo e(number_format($totalBRITruck + $totalBCATruck + $totalBNITruck + $totalMandiriTruck + $totalQRISTruck)); ?></td>
                    <td align="right"><?php echo e(number_format($result->total)); ?></td>
                    <?php
            ...
            <tr>
                ...
                <td><strong><?php echo e(number_format($totalharianmobil + $totalharianmotor + $totalhariantruck)); ?></strong></td>
            </tr>
        </tbody>
    </table>
...
</html><?php /**PATH D:\laragon\www\Intermark\resources\views/PDF/pdfqty.blade.php ENDPATH**/ ?>