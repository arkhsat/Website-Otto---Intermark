                            ...
                            <tbody>
                                @foreach($results as $index => $result)
                                    <tr role="row">
                                        ...
                                        <td style="text-align: center">Rp {{ number_format($result->Mandiri_Truck) }}</td>
                                        ...
                                        <td style="text-align: center">Rp {{ number_format($result->BCA_Truck) }}</td>
                                        ...
                                        <td style="text-align: center">Rp {{ number_format($result->BNI_Truck) }}</td>
                                        ...
                                        <td style="text-align: center">Rp {{ number_format($result->BRI_Truck) }}</td>
                                        ...
                                        <td style="text-align: center">Rp {{ number_format($result->QRIS_Truck) }}</td>
