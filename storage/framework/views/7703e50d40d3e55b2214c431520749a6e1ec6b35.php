    ...
    <table>
        <thead>
            <thead>
                ...
                <th style="width: 20%;">Jenis Member</th>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr role="row">
                    ...
                    <td><?php echo e(number_format($result->biaya)); ?></td>
                </tr>
                <?php
            ...
            <tr>
                ...
                <td style="font-weight: bold;"><?php echo e(number_format($totalBiaya)); ?></td>
            </tr>
        </tbody>
    </table>
...
</html><?php /**PATH E:\Kerja\02. Intermark\Website Parking\parkingsystem\parkingsystem\resources\views/PDF/pdfperpanjangmember.blade.php ENDPATH**/ ?>