...
class ReportVoucher2 implements FromView, WithDrawings, WithTitle, WithStyles
{
    protected $startDate;
    protected $endDate;
    protected $judul;
    ...
    public function __construct($car_duration, $startDate, $endDate, $judul)
    {   
    ...
    {
        return view('exports.reportvoucher_mobil', [
            'datahours' => $this->car_duration,
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A2:P' . (count($this->car_duration) + 3))
              ->getBorders()
              ->getAllBorders()
              ->setBorderStyle(Border::BORDER_THIN);
        $sheet->getStyle('A1:P' . (count($this->car_duration) + 3))
              ->getAlignment()
        ...
        $sheet->getStyle('A3:P' . (count($this->car_duration) + 3))->getFont()->setSize(9);
        ...
        foreach ($this->car_duration as $row => $result) {
            $excelRow = $row + 3;
