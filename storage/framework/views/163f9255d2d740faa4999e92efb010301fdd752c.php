...
<?php $__env->startSection('breadcrumb'); ?>
    <ul class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active">
            <a href="#"><?php echo e(__('Tanda Terima Member')); ?></a>
        </li>
    </ul>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('tanda.terima.view')); ?>" method="GET">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WEB Baru\web-admin-dev\resources\views/tanda_terima/index.blade.php ENDPATH**/ ?>