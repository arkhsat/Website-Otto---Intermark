                    ...
                    <table class="display dataTable cell-border datatbl-advance">
                        ...
                        <?php $__currentLoopData = $parkings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr role="row">
                                ...
                                <td>
                                    <?php if($parking->vehicleimage): ?>
                                        <img src="<?php echo e(asset('storage/'.$parking->vehicleimage)); ?>" alt="Vehicle Image" style="width: 100px; height: auto;">
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Kerja\02. Intermark\Website Parking\parkingsystem\parkingsystem\resources\views/parking/index.blade.php ENDPATH**/ ?>