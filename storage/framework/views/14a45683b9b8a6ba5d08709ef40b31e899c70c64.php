...
<head>
    ...
    <meta property="twitter:image" content="<?php echo e(asset(Storage::url('upload/seo')).'/'.$settings['meta_seo_image']); ?>">
        <link href="<?php echo e(asset('assets/css/vendor/select2.min.css')); ?>" rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('assets/css/vendor/font.css')); ?>" rel="stylesheet" />
...
<link href="<?php echo e(asset('assets/css/vendor/select2.min.css')); ?>" rel="stylesheet" />
    ...
    <!-- Lightbox2 CSS -->
    <link href="<?php echo e(asset('assets/css/vendor/lightbox.min.css')); ?>" rel="stylesheet" />
...
<!-- <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script> <?php echo e(asset('assets/css/vendor/lightbox.min.css')); ?>" rel="stylesheet" /> -->
...
<?php /**PATH D:\laragon\www\web-admin-dev\resources\views/admin/head.blade.php ENDPATH**/ ?>