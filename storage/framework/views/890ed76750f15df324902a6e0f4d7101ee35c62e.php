...
<?php $__env->startSection('card-action-btn'); ?>
    <?php if(Gate::check('create gate type')): ?>
        <a class="btn btn-primary btn-sm ml-20 customModal" href="#" data-size="md"
           data-url="<?php echo e(route('gate-type.create')); ?>"
           data-title="<?php echo e(__('Create Gate Type')); ?>"> <i class="ti-plus mr-5"></i><?php echo e(__('Gate Type')); ?></a>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\web-admin-dev\resources\views/gate_type/index.blade.php ENDPATH**/ ?>