{{ Form::model($rfidVehiclebluebird, [
...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            {{ Form::label('uidno', __('UID No'), ['class' => 'form-label']) }}
            {{ Form::text('uidno', null, ['class' => 'form-control', 'placeholder' => __('Masukkan UID No')]) }}
        </div>
...
$(document).ready(function () {
    var member_type = "{{ $rfidVehiclebluebird->member_type }}"; // Ambil nilai dari Blade
