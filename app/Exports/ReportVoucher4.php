...
class ReportVoucher4 implements FromView, WithDrawings, WithTitle, WithStyles
{
    protected $startDate;
    protected $endDate;
    protected $judul;
    ...
    public function __construct($truck_duration, $startDate, $endDate, $judul)
    {   
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A2:AA' . (count($this->truck_duration) + 3))
              ->getBorders()
              ->getAllBorders()
              ->setBorderStyle(Border::BORDER_THIN);
        $sheet->getStyle('A1:AA' . (count($this->truck_duration) + 3))
              ->getAlignment()
        ...
        $sheet->getStyle('A3:AA' . (count($this->truck_duration) + 3))->getFont()->setSize(9);
        ...
        foreach ($this->truck_duration as $row => $result) {
            $excelRow = $row + 3;
