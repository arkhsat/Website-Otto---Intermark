...
<aside class="codex-sidebar sidebar-<?php echo e($settings['sidebar_mode']); ?>">
    ...
    <div class="codex-menuwrapper">
        <ul class="codex-menu custom-scroll" data-simplebar>
            ...
            <li class="menu-item <?php echo e(in_array($routeName,['report.summary.member.qty',''])?'active':''); ?>">
                <a href="<?php echo e(route('report.summary.member.qty')); ?>">
                    <div class="icon-item"><i data-feather="book"></i></div>
                    <span><?php echo e(__('Report Summary Member Qty')); ?></span>
                </a>
            </li>
            ...
            <li class="menu-item <?php echo e(in_array($routeName,['report.summary.pos.qty',''])?'active':''); ?>">
                <a href="<?php echo e(route('report.summary.pos.qty')); ?>">
                    <div class="icon-item"><i data-feather="book"></i></div>
                    <span><?php echo e(__('Report Summary Pos In & Out Qty')); ?></span>
                </a>
            </li>
...
>>>>>>> 5e1b1a02dac782a8bd3b6f2001176ab9e5ceb7b2
            ...
            <?php if(Gate::check('manage pricing packages') || Gate::check('manage pricing transation') || Gate::check('manage account settings') || Gate::check('manage password settings') || Gate::check('manage general settings') || Gate::check('manage company settings')): ?>
                ...
                <?php if(Gate::check('manage pricing packages') || Gate::check('manage pricing transation')): ?>
                    <li class="menu-item <?php echo e(in_array($routeName,['subscriptions.index','subscriptions.show','subscription.transaction'])?'active':''); ?>">
                        ...
                        <ul class="submenu-list"
                            ...
                            <?php endif; ?>
                            <?php if(Gate::check('manage pricing transation')): ?>
                                <li class="<?php echo e(in_array($routeName,['setting.price'])?'active':''); ?> ">
                                    <a href="<?php echo e(route('setting.price')); ?>"><?php echo e(__('Price')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if(Gate::check('manage pricing packages') || Gate::check('manage pricing transation')): ?>
                    <li class="<?php echo e(in_array($routeName,['setting.guest-types'])?'active':''); ?> ">
                        <a href="<?php echo e(route('setting.guest-types')); ?>"><?php echo e(__('Guest Types')); ?>
...
<!-- sidebar end-->
<?php /**PATH D:\laragon\www\Intermark\resources\views/admin/menu.blade.php ENDPATH**/ ?>