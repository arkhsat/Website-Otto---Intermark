...
{{ Form::open(array('url' => 'rfid-vehicle-car', 'method' => 'post')) }}
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            {{ Form::label('rfid_no', __('RFID No'), array('class' => 'form-label')) }}
            {{ Form::text('rfid_no', null, array('class' => 'form-control', 'placeholder' => __('Masukkan No RFID'))) }}
        </div>
    </div>
