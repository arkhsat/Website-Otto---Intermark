...
class ReportQtyMemberExport4 implements FromView, WithDrawings, WithTitle, WithStyles
{
    protected $startDate;
    protected $endDate;
    protected $judul;
    ...
    public function __construct($car_datahours_in, $startDate, $endDate, $judul)
    {   
    ...
    {
        return view('exports.reportexcelmemberqty3', [
