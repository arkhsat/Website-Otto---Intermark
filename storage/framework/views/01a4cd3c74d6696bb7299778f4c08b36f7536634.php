...
<?php $__env->startSection('breadcrumb'); ?>
    <ul class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active">
            <a href="#"><?php echo e(__('RFID Car')); ?></a>
        </li>
    </ul>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('card-action-btn'); ?>
        <a class="btn btn-primary btn-sm ml-20 customModal" href="#" data-size="lg"
           data-url="<?php echo e(route('rfid-vehicle-car.create')); ?>"
           data-title="<?php echo e(__('Create RFID Car')); ?>">
            <i class="ti-plus mr-5"></i><?php echo e(__('Create RFID Car')); ?>
                                ...
                                <tr>
                                    <td>
                                        <a class="text-success customModal" data-bs-toggle="tooltip"
                                           ...
                                           data-url="<?php echo e(route('rfid-vehicle-car.edit', $vehicle->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\WEB Baru\web-admin-dev\resources\views/rfid_car/index.blade.php ENDPATH**/ ?>