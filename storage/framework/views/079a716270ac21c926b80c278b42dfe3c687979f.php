...
<?php $__env->startSection('breadcrumb'); ?>
    <ul class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active">
            <a href="#"><?php echo e(__('Report Transaksi Voucher')); ?></a>
        </li>
    </ul>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form id="hotel-report-form" action="<?php echo e(route('report.voucher.intermark.data')); ?>" method="GET">
                    ...
                    <?php if(!empty($results)): ?>
                        <div style="margin-bottom: 10px;">
                            ...
                            <a href="<?php echo e(route('report.voucher.intermark.pdf', [
                            ...
                            <a href="<?php echo e(route('report.voucher.intermark.excel', [
                                'entry_date' => request('entry_date'),
                                'end_date' => request('end_date'),
                                'voucher_type' => $voucherType
                            ])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Intermark\resources\views/reportvoucher/index-intermark.blade.php ENDPATH**/ ?>