<?php echo e(Form::model($vehicle, [
    'route' => ['rfid-extend.update', $vehicle->id], 'method' => 'PUT', 'id' => 'formUpdate'])); ?>

<div class="modal-body">
    <input type="hidden" id="end_date_db" value="<?php echo e($vehicle->end_date); ?>">
...
<div class="modal-footer">
    ...
    <?php echo e(Form::submit(__('Update'), array('class' => 'btn btn-primary btn-rounded', 'id' => 'BTNUpdate'))); ?>
...
</script><?php /**PATH D:\laragon\www\Intermark\resources\views/rfid_extend/edit.blade.php ENDPATH**/ ?>