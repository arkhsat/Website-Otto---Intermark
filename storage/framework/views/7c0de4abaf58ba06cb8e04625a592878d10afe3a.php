<?php echo e(Form::model($rfidVehiclecar, [
...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            <?php echo e(Form::label('rfid_no', __('RFID No'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::text('rfid_no', null, ['class' => 'form-control', 'placeholder' => __('Masukkan RFID No')])); ?>
...
$(document).ready(function () {
    var member_type = "<?php echo e($rfidVehiclecar->member_type); ?>"; // Ambil nilai dari Blade
...
<?php /**PATH E:\web-admin-dev\resources\views/rfid_car/edit.blade.php ENDPATH**/ ?>