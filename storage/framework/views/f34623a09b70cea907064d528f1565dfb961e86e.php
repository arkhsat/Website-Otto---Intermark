...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('name', null, array('class' => 'form-control', 'placeholder' => __('Masukkan Nama')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('phone_number', __('Nomor HP'), array('class' => 'form-label'))); ?>

            <?php echo e(Form::text('phone_number', null, array('class' => 'form-control', 'placeholder' => __('Masukkan Nomor HP')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('vehicle_type', __('Jenis Kendaraan'), array('class' => 'form-label'))); ?>

            <?php echo e(Form::select('vehicle_type', ['' => __('Pilih Jenis Kendaraan')] + $vehicleTypes->toArray(), null, array('class' => 'form-control hidesearch', 'id' => 'vehicle_type'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('company_name', __('Nama Perusahaan'), array('class' => 'form-label'))); ?>

            <?php echo e(Form::text('company_name', null, array('class' => 'form-control', 'placeholder' => __('Pilih Nama Perusahaan')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('membertype', __('Produk'), array('class' => 'form-label'))); ?>

            <?php echo e(Form::select('membertype', [], null, array('class' => 'form-control hidesearch', 'id' => 'product_code', 'placeholder' => 'Pilih Produk'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('vehicle_no', __('Nomor Polisi'), array('class' => 'form-label'))); ?>

            <?php echo e(Form::text('vehicle_no', null, array('class' => 'form-control', 'placeholder' => __('Masukkan Nomor Polisi')))); ?>
        ...
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::text('rfid_no', null, array('class' => 'form-control', 'placeholder' => __('Masukkan Nomor RFID')))); ?>
...
</script><?php /**PATH E:\Kerja\parkingsystem\parkingsystem\resources\views/rfid_vehicle/create.blade.php ENDPATH**/ ?>