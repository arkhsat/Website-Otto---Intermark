        ...
        <tbody>
            ...
            <?php $__currentLoopData = $datahours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $hours): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr role="row">
                    ...
                    <td align="right"><?php echo e(number_format($hours->s0sampai1 + $hours->s1sampai2 + $hours->s2sampai3 + $hours->s3sampai4 + $hours->s4sampai5 + $hours->s5sampai6 + $hours->s6sampai7 + $hours->s7sampai8 + $hours->s8sampai9 + $hours->s9sampai10 + $hours->s10sampai11 + $hours->s11sampai12 + $hours->diatas12)); ?></td>
                </tr>
                <?php
            ...
            <tr>
                ...
                <td align="right"><strong><?php echo e(number_format($totalDiatas12)); ?></strong></td>
                <td align="right"><strong><?php echo e(number_format($total0sampai1 + $total1sampai2 + $total2sampai3 + $total3sampai4 + $total4sampai5 + $total5sampai6 + $total6sampai7 + $total7sampai8 + $total8sampai9 + $total9sampai10 + $total10sampai11 + $total11sampai12 + $totalDiatas12)); ?></strong></td>
            </tr>
        </tbody>
    </table>
</body>
</html><?php /**PATH E:\Kerja\02. Intermark\Website Otto\resources\views/exports/reportexcelamount2.blade.php ENDPATH**/ ?>