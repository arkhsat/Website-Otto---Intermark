...
class ReportPerpanjangMember implements  FromView, WithDrawings, WithTitle, WithStyles
{
    protected $data;
    protected $startDate;
    protected $endDate;
    ...
    {
        return view('exports.reportmemberperpanjang', [
            'data' => $this->data,
    ...
    {
        return 'Report Perpanjangan Member';
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A3:H'.count($this->data) + 2)->getFont()->setSize(9);
