...
class ReportVoucher4 implements FromView, WithDrawings, WithTitle, WithStyles
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A2:P' . (count($this->truck_duration) + 3))
              ->getBorders()
              ->getAllBorders()
              ->setBorderStyle(Border::BORDER_THIN);
        $sheet->getStyle('A1:P' . (count($this->truck_duration) + 3))
              ->getAlignment()
        ...
        $sheet->getStyle('A3:P' . (count($this->truck_duration) + 3))->getFont()->setSize(9);
