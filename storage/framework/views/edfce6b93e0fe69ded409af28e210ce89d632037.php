...
<?php echo e(Form::open(array('url' => 'rfid-vehicle-car', 'method' => 'post'))); ?>

<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            <?php echo e(Form::label('rfid_no', __('RFID No'), array('class' => 'form-label'))); ?>

            <?php echo e(Form::text('rfid_no', null, array('class' => 'form-control', 'placeholder' => __('Masukkan No RFID')))); ?>
...
</script><?php /**PATH E:\web-admin-dev\resources\views/rfid_car/create.blade.php ENDPATH**/ ?>