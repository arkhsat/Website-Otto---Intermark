...
class ReportAmountExport7 implements FromView, WithDrawings, WithTitle, WithStyles
{
    protected $startDate;
    protected $endDate;
    protected $judul;
    ...
    {
                $sheet->getStyle('A2:Z' . (count($this->truck_datahours_in) + 3))
              ->getBorders()
              ->getAllBorders()
              ->setBorderStyle(Border::BORDER_THIN);
        $sheet->getStyle('A1:Z' . (count($this->truck_datahours_in) + 3))
              ->getAlignment()
        ...
        $sheet->getStyle('A3:Z' . (count($this->truck_datahours_in) + 3))->getFont()->setSize(9);
