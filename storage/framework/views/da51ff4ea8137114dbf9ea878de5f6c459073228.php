...
<?php $__env->startSection('breadcrumb'); ?>
    <ul class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active">
            <a href="#"><?php echo e(__('Report Perpanjangan Member')); ?></a>
        </li>
    </ul>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('reportmember.daily')); ?>" method="GET">
                    ...
                    <div style="margin-bottom: 10px;">
                        <a href="<?php echo e(route('reportmember.daily.pdf', ['entry_date' => request('entry_date', date('Y-m-d')), 'end_date' => request('end_date', date('Y-m-d'))])); ?>" class="btn btn-primary">Download PDF</a>
                        <a href="<?php echo e(route('reportmember.daily.excel', ['entry_date' => request('entry_date', date('Y-m-d')), 'end_date' => request('end_date', date('Y-m-d'))])); ?>" class="btn btn-success">Download Excel</a>
                    </div>
                    <table class="display dataTable cell-border">
                        <thead>
                            <thead>
                                <td class="xl66" style="height: 32.0pt; width: 65pt;">No</td>
                                <td class="xl66" style="width: 65pt;">Tanggal Bayar</td>
                                <td class="xl65" style="width: 130pt;">Nama</td>
                                <td class="xl65" style="width: 130pt;">Jenis Member</td>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr role="row">
                                    ...
                                    <td>Rp <?php echo e(number_format($result->biaya, 0, ',', '.')); ?></td>
                                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Kerja\02. Intermark\Website Parking\parkingsystem\parkingsystem\resources\views/reportmember/reportmemberdaily.blade.php ENDPATH**/ ?>