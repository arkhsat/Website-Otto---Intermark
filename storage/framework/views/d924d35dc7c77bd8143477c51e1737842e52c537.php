                ...
                <div class="card-body">
                    <table class="display dataTable cell-border datatbl-advance">
                        ...
                        <tr>
                            ...
                            <th><?php echo e(__('User Count')); ?></th>
                            <th><?php echo e(__('Permissions Count')); ?></th>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="cart-action">
                                        ...
                                        <?php endif; ?>
                                        <?php if($role->name !='employee' && $role->name !='customer'): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Intermark\resources\views/role/index.blade.php ENDPATH**/ ?>