...
class ReportVoucher2 implements FromView, WithDrawings, WithTitle, WithStyles
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A2:AA' . (count($this->car_duration) + 3))
              ->getBorders()
              ->getAllBorders()
              ->setBorderStyle(Border::BORDER_THIN);
        $sheet->getStyle('A1:AA' . (count($this->car_duration) + 3))
              ->getAlignment()
        ...
        $sheet->getStyle('A3:AA' . (count($this->car_duration) + 3))->getFont()->setSize(9);
