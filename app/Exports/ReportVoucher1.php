...
class ReportVoucher1 implements FromView, WithDrawings, WithTitle, WithStyles
{
    protected $startDate;
    protected $endDate;
    protected $judul;
    protected $all_duration;

    public function __construct($all_duration, $startDate, $endDate, $judul)
    {   
