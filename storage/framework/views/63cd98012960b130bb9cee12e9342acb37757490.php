...
<body>
    <div class="header">
        ...
        <div class="title">
            ...
            <p>Tanggal : 
                <?php echo e(date('d F Y', strtotime($Date))); ?>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>Mandiri</td>
                <td><?php echo e(number_format($result->Lalin_Mandiri_Motor + $result->Lalin_Mandiri_Mobil)); ?></td>
                <td><?php echo e(number_format($result->Amount_Mandiri_Motor + $result->Amount_Mandiri_Mobil)); ?></td>
            </tr>
            <tr>
                <td>BCA</td>
                <td><?php echo e(number_format($result->Lalin_BCA_Motor + $result->Lalin_BCA_Mobil)); ?></td>
                <td><?php echo e(number_format($result->Amount_BCA_Motor + $result->Amount_BCA_Mobil)); ?></td>
            </tr>
            <tr>
                <td>BNI</td>
                <td><?php echo e(number_format($result->Lalin_BNI_Motor + $result->Lalin_BNI_Mobil)); ?></td>
                <td><?php echo e(number_format($result->Amount_BNI_Motor + $result->Amount_BNI_Mobil)); ?></td>
            </tr>
            <tr>
                <td>BRI</td>
                <td><?php echo e(number_format($result->Lalin_BRI_Motor + $result->Lalin_BRI_Mobil)); ?></td>
                <td><?php echo e(number_format($result->Amount_BRI_Motor + $result->Amount_BRI_Mobil)); ?></td>
            </tr>
            <tr>
                <td>Member</td>
                <td><?php echo e(number_format($result->Lalin_Member_Motor + $result->Lalin_Member_Mobil)); ?></td>
                <td><?php echo e(number_format($result->Amount_Member_Motor + $result->Amount_Member_Mobil)); ?></td>
            </tr>
            <tr>
                <td>Hotel</td>
                <td><?php echo e(number_format($result->Lalin_Hotel_Motor + $result->Lalin_Hotel_Mobil)); ?></td>
                <td><?php echo e(number_format($result->Amount_Hotel_Motor + $result->Amount_Hotel_Mobil)); ?></td>
            </tr>
            <tr>
...
</html><?php /**PATH E:\Kerja\parkingsystem\parkingsystem\resources\views/pdf/pdfreportdaily.blade.php ENDPATH**/ ?>