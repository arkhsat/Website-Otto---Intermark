...
.subtotal-row td:last-child {
    border: 1px solid black; /* Atau sesuai gaya border yang kamu pakai */
        ...
        <div class="header">
            <div class="left">
                <img class="logo-img" src="<?php echo e(asset('images/Logo Utama.png')); ?>" alt="Otto Parking">
        ...
        <div class="section">
            <div class="row">
                <div class="label">Date</div><div>:</div><div class="value"><?php echo e($date2); ?></div>
            </div>
            <div class="row">
                <div class="label">Tanda Terima No.</div><div>:</div><div class="value"><?php echo e($nomor_full); ?></div>
            </div>
        </div>

        <div class="section">
            <p><strong>To:</strong></p>
            <p><strong><?php echo e($client); ?></strong></p>
...
<tr>
    <td>
        Pembayaran membership <?php echo e($value_kendaraan); ?> <?php echo e($date); ?><br>
        <?php if($showNopolList): ?>
    No Polisi Terlampir:
    <ul>
        <?php $__currentLoopData = $nopollist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nopol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li><?php echo e($nopol); ?></li>
...
<tr>
    <td>
        ...
        <?php if($addon): ?>
    <ul>
        <li>Pembuatan Kartu Baru Untuk <?php echo e($value_kendaraan); ?></li>
    </ul>
        <?php endif; ?>
    </td>
    <td style="text-align:center;"><?php echo e($item->qty); ?></td>
    <td>Rp <?php echo e(number_format($item->newcard , 0, ',', '.')); ?></td>
    <td>Rp <?php echo e(number_format($subadd, 0, ',', '.')); ?></td>
</tr>
<?php endif; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH D:\laragon\www\Intermark\resources\views/tanda_terima/tanda_terima.blade.php ENDPATH**/ ?>