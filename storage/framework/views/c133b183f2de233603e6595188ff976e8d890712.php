...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::text('rfid_no', null, ['class' => 'form-control', 'placeholder' => __('Masukkan Nomor RFID'), 'id' => 'rfid_no', 'readonly' => 'readonly'])); ?>
...
$(document).ready(function () {
    ...
    $('input[name="card_status"]').on('change', function () {
        if ($('#card_lost').is(':checked') || $('#card_damaged').is(':checked')) {
            $('#rfid_no').prop('disabled', false); // Enable input RFID
        } else {
            $('#rfid_no').prop('disabled', true); // Disable input RFID
        }
    });
...
<?php /**PATH E:\Kerja\02. Intermark\Website Parking\parkingsystem\parkingsystem\resources\views/rfid_vehicle/edit.blade.php ENDPATH**/ ?>