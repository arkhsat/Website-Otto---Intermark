    ...
    <div class="codex-authbox">
        <div class="auth-header">
            <div class="codex-brand">
                <a href="#">
                    <img class="img-fluid light-logo" style="height: auto !important" src="<?php echo e(asset('images\Logo Utama.png')); ?>" alt="Logo Utama">
                    <img class="img-fluid dark-logo" style="height: auto !important" src="<?php echo e(asset('images\Logo Utama.png')); ?>" alt="Logo Utama">
                </a>
            </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if($registerPage=='on'): ?>
            <div class="auth-footer">
                <h6 class="text-center"><?php echo e(__('Dont have an account?')); ?> <a class="text-primary"
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Kerja\02. Intermark\Website Parking\parkingsystem\parkingsystem\resources\views/auth/login.blade.php ENDPATH**/ ?>