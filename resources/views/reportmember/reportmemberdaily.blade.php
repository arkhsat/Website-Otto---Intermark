...
@section('breadcrumb')
    <ul class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active">
            <a href="#">{{ __('Report Perpanjangan Member') }}</a>
        </li>
    </ul>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('reportmember.daily') }}" method="GET">
                    ...
                    <div style="margin-bottom: 10px;">
                        <a href="{{ route('reportmember.daily.pdf', ['entry_date' => request('entry_date', date('Y-m-d')), 'end_date' => request('end_date', date('Y-m-d'))]) }}" class="btn btn-primary">Download PDF</a>
                        <a href="{{ route('reportmember.daily.excel', ['entry_date' => request('entry_date', date('Y-m-d')), 'end_date' => request('end_date', date('Y-m-d'))]) }}" class="btn btn-success">Download Excel</a>
                    </div>
