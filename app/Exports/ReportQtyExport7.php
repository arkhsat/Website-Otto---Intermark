...
class ReportQtyExport7 implements FromView, WithDrawings, WithTitle, WithStyles
{
    protected $startDate;
    protected $endDate;
    protected $judul;
    ...
    public function __construct($truck_datahours_in, $startDate, $endDate, $judul)
    {   
    ...
    public function view(): View
    {
        return view('exports.reportexcelqty3', [
            'datahours' => $this->truck_datahours_in,
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A2:AA' . (count($this->truck_datahours_in) + 3))
              ->getBorders()
              ->getAllBorders()
              ->setBorderStyle(Border::BORDER_THIN);
        $sheet->getStyle('A1:AA' . (count($this->truck_datahours_in) + 3))
              ->getAlignment()
        ...
        $sheet->getStyle('A3:AA' . (count($this->truck_datahours_in) + 3))->getFont()->setSize(9);
        ...
        foreach ($this->truck_datahours_in as $row => $result) {
            $excelRow = $row + 3;
