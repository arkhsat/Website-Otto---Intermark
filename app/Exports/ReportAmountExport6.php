...
class ReportAmountExport6 implements FromView, WithDrawings, WithTitle, WithStyles
{
    protected $startDate;
    protected $endDate;
    protected $judul;
    ...
    public function __construct($truck_datahours, $startDate, $endDate, $judul)
    {   
    ...
    public function view(): View
    {
        return view('exports.reportexcelamount2', [
            'datahours' => $this->truck_datahours,
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A2:P' . (count($this->truck_datahours) + 3))
              ->getBorders()
              ->getAllBorders()
              ->setBorderStyle(Border::BORDER_THIN);
        $sheet->getStyle('A1:P' . (count($this->truck_datahours) + 3))
              ->getAlignment()
        ...
        $sheet->getStyle('A3:P' . (count($this->truck_datahours) + 3))->getFont()->setSize(9);
        ...
        foreach ($this->truck_datahours as $row => $result) {
            $excelRow = $row + 3;
