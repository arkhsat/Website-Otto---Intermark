                        ...
                        <?php if($hotel == 'SBSR'): ?> 
                            ...
                            <div style="margin-bottom: 10px;">
                                <a href="<?php echo e(route('report.hotel.SBSR.pdf', ['entry_date' => request('entry_date', date('Y-m-d')), 'end_date' => request('end_date', date('Y-m-d')), 'hotel' => request('hotel')])); ?>" class="btn btn-primary">Download PDF</a>
                                 <!-- <a href="<?php echo e(url('report-hotel/pdf/SBSR?entry_date=' . request('entry_date', date('Y-m-d')) . '&end_date=' . request('end_date', date('Y-m-d')) . '&hotel=' . request('hotel'))); ?>" class="btn btn-primary">
                                    Download PDF
                                    </a> -->
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row">
                                            ...
                                            <td><?php echo e($result->tipe_guest); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Intermark\resources\views/reporthotel/index.blade.php ENDPATH**/ ?>