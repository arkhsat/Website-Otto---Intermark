<?php echo e(Form::open(array('url' => 'company', 'method' => 'post'))); ?>
...
<div class="modal-footer">
    ...
    <?php echo e(Form::submit(__('Edit Data'), ['class' => 'btn btn-primary btn-rounded'])); ?>

</div>
<?php echo e(Form::close()); ?>


<?php /**PATH E:\Kerja\02. Intermark\Website Parking\parkingsystem\parkingsystem\resources\views/company/add.blade.php ENDPATH**/ ?>