                ...
                <div class="card-body">
                    <table class="display dataTable cell-border datatbl-advance">
                        <thead>
                            ...
                            <th><?php echo e(__('Type Of Guest')); ?></th>
                        ...
                        <?php $__currentLoopData = $hotels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr role="row">
                                ...
                                <!-- <td> <?php echo e(ucfirst($hotel->type)); ?>   </td> -->
                                <td> <?php echo e(ucfirst($hotel->hotelType->type ?? '')); ?></td>
                                <!-- <td><?php echo e(optional($hotel->hotelType)->name); ?></td> -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Intermark\resources\views/hotel/index.blade.php ENDPATH**/ ?>