...
@section('card-action-btn')
        <a class="btn btn-primary btn-sm ml-20 customModal" href="#" data-size="lg"
           data-url="{{ route('rfid-vehicle-bluebird.create') }}"
           data-title="{{ __('Create RFID Blue Bird') }}">
            <i class="ti-plus mr-5"></i>{{ __('Create UID Blue Bird') }}
        </a>
@endsection
                                ...
                                <tr>
                                    <td>
                                        <a class="text-success customModal" data-bs-toggle="tooltip"
                                           ...
                                           data-url="{{ route('rfid-vehicle-bluebird.edit', $vehicle->id) }}"
                                           data-title="{{ __('Edit RFID Blue Bird') }}">
                                            {{ $vehicle->uidno }}
                                        </a>
                                    </td>
                                        <td class="text-right">
